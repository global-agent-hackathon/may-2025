...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 8.1 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("If anyone tries to change a block, the whole chain breaks apart—making tampering...", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 8.1 - 4.5)
