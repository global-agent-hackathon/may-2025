...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 6.2 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("Imagine a notebook where every transaction is written down for everyone to see", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 6.2 - 4.5)
