...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 3.8 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("Now, picture each page as a \'block", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 3.8 - 4.5)
