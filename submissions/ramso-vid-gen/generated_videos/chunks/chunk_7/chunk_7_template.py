...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 3.0 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("Where could you imagine using it?", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 3.0 - 4.5)
