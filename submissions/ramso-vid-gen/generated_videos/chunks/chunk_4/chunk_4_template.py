...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 6.5 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("\' When a page is full, it gets locked and linked to the last one, forming a chai...", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 6.5 - 4.5)
