...
class VideoScene(Scene):
    def construct(self):
        # Simple animation that exactly matches audio duration: 2.8 seconds
        
        # Create main text (actual chunk content)
        main_text = Text("What is Blockchain Technology?", font_size=28, color=WHITE)
        ...
        remaining_time = max(0.5, 2.8 - 4.5)
